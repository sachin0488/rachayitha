...
import { useReportBookService, useReportCategoryService } from 'Container/BookDetail/services/ReportBook.service'

const ReportModal = ({ open, setOpen, bookId }) => {
  const { Data, isLoading } = useReportCategoryService({ enabled: open })
  const { mutate, isLoading: isMutating, isSuccess } = useReportBookService({ bookId: bookId })

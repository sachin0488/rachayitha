    ...
    <>
      <AboutSectionWrapper>
        <AboutSectionUpperContent>
          ...
          >
            “Discovered the corpse of an ordinary human, loot to receive
            Super-strength Pill, extract?”
          </Typography>
          <Typography
            style={{ fontSize: "12px", fontWeight: "300", lineHeight: "14px" }}
          >
          ...
          <Typography
            style={{ fontSize: "12px", fontWeight: "300", lineHeight: "14px" }}
          >
            “Discovered the Demonic Body of the Hellbound Domination Emperor,
            loot to receive Sun-swallowing Cerberus, extract?”
          </Typography>
        </AboutSectionUpperContent>
        <AboutSectionUpperContent>
          <Typography style={{ color: "#2C2B5B" }}>Tags</Typography>
          <Typography
            style={{ color: "#5A2CC6", fontSize: "12px", fontWeight: "500" }}
          >

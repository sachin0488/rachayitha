                ...
                <div className="dg gtc2 ml64 mr64  db-m ml-m-16 mr-m-16">
                    <div>
                        <h1 className="ff_ubuntu ttu fs56 fs-l-48 fs-m-28 mb8 mt-l-0 lh1d3 ">
                            {contestDetail?.contest_name} <span className="c_primary">{
                                new Date().getFullYear()
                            }</span>
                            <i className="title-new"></i>
                        </h1>
                        <small className="ff_gh lh1d3 fs24 fs-l-20 fs-m-16 c_primary title-decorate">Organized by {contestDetail?.organiser_name}</small>

                        <img
                            className="w100p dn db-m mt24 mb24"
                            style={{ filter: 'hue-rotate(281deg)' }}
                            src={contestDetail?.contest_img}
                        />
                        <div className="border-bottom-primary-reverse mb20 dn-m"></div>
                        <p className="mb20 mb-m-16 fs16 fs-m-14 lh1d5 lh-m-1d57">
                            {contestDetail?.contest_description}
                        </p>
                        <div className="header-icons">
                            ...
                            <div className="df mb40 aic">
                                ...
                                <div>
                                    <strong className="db ff_ubuntu fs24 fs-m-16 lh1d5">{contestDetail?.contest_prize} INR</strong>
